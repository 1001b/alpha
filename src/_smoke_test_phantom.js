/**
 Copyright (c) 2015 amihire. All rights reserved. See LICENSE.txt for details.  Created by amihire on 2015.
 */
(function() {
    "use strict";
    ...
    exports.test_runPhantomJsTests = function(test) {
        var phantomJsProcess = child_process.spawn("node", ["node_modules/phantomjs/bin/phantomjs", "src/_phantom.js"], { stdio: "inherit" });
